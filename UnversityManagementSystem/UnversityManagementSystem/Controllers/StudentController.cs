...
namespace UnversityManagementSystem.Controllers
{
    public class StudentController : Controller
    {
        ...
        public JsonResult IsStudentEmailAvailable(string Email)
        {
            ...
            return Json(!db.Students.Any(x => x.Email == Email),
        ...
        public ActionResult Create([Bind(Include="StudentId,StudentName,Email,ContactNo,Date,Address,DepartmentId")] Student student)
        {
            if (ModelState.IsValid)
            {
                ...
                //TempData["Success"] ="Welcome "+ student.StudentName + ", Your Registration Id: " + student.RegistrationId;
